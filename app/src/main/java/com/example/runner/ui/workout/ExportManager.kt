...
class ExportManager(
    ...
    fun exportWorkoutToGpx(workout: Workout): Boolean {
        try {
            ...
            val gpxContent = com.example.runner.util.GpxExporter.exportWorkoutToGpx(workout, trackData, activity)
    ...
    private fun saveAndShareGpxFile(gpxContent: String, workout: Workout) {
        try {
            val fileName = com.example.runner.util.GpxExporter.getGpxFileName(workout, activity)
