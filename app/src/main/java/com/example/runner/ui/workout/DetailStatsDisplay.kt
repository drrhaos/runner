...
class DetailStatsDisplay(
    private val binding: com.example.runner.databinding.FragmentWorkoutDetailBinding,
    ...
    fun displayWorkout(workout: Workout) {
        binding.apply {
            ...
            textViewDetailDistance.text = com.example.runner.util.FormatUtils.formatDistance(workout.distance, context)
            ...
            textViewDetailAvgSpeed.text = com.example.runner.util.FormatUtils.formatSpeed(avgSpeed, true, context)

            textViewDetailCalories.text = com.example.runner.util.FormatUtils.formatCalories(workout.calories ?: 0, context)
        }
    }
