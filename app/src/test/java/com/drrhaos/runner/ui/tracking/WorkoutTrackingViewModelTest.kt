...
import com.drrhaos.runner.data.*
...
@Config(sdk = [28], application = com.drrhaos.runner.RunnerApplication::class)
...
class WorkoutTrackingViewModelTest {
    ...
    @Test
    fun viewmodel_should_handle_workout_state_transitions() = runTest {
