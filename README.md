...
### 📋 Планы тренировок
- **Базовые тренировки** — шаблоны с упорядоченными интервалами (время / дистанция, опциональный темп)
- **Планы** — назначение шаблонов по дням, «повторить до конца», наложение на календарь с даты старта
- На экране трекинга при активном плане: переключатель «По плану», шкала текущего интервала, голосовое объявление смены интервала
